...
void runV0(TString filelist="/lustre/nyx/alice/users/mciupek/TPCSpline/SplineCreationFramework/TPCSplineFramework_SkimmedData/BBFitAnalysis/list/V0_LHC18q.list",TString filelist_track="/lustre/nyx/alice/users/mciupek/TPCSpline/SplineCreationFramework/TPCSplineFramework_SkimmedData/BBFitAnalysis/list/track_LHC18q.list", TString outfile="TPCresidualPID_LHC18q.root", TString outfile_Tree = "TPCPIDEtaTree_LHC18q.root") {

  gSystem->Load("/lustre/nyx/alice/users/mciupek/TPCSpline/SplineCreationFramework/TPCSplineFramework_SkimmedData/BBFitAnalysis/AliSkimmedDataAnalysisMaker.so");

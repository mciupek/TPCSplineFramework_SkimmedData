...
runFolder=/lustre/nyx/alice/users/mciupek/TPCSpline/SkimmedData_Framework/output_SkimmedData

while read run; do
  mkdir -p $runFolder/data/2018/LHC18q/$run
  cd $runFolder/data/2018/LHC18q/$run
  ls -1v /lustre/nyx/alice/users/mciupek/TPCSpline/SkimmedData_Framework/output_test/data/2018/LHC18q/$run/pass3/chunks_*/V0tree.root > V0_LHC18q_$run.list
  ls -1v /lustre/nyx/alice/users/mciupek/TPCSpline/SkimmedData_Framework/output_test/data/2018/LHC18q/$run/pass3/chunks_*/CleanTrack.root > track_LHC18q_$run.list
  ...
  .L /lustre/nyx/alice/users/mciupek/TPCSpline/SkimmedData_Framework/code_SplineInput_changed/runV0.C

...
void enablePileUpCorrection(){
  AliPIDtools::GetTPCPID(pidHash).SetPileupCorrectionObject(AliPIDtools::GetTPCPID(pidHash).GetPileupCorrectionFromFile("/lustre/alice/users/miranov/NOTESData/alice-tpc-notes/JIRA/PWGPP-538/new/alice/data/2015/LHC15o/pass2/AOD/dEdxFitLight.root"));
}
...
//  cout<<Form("New eta maps from %s",eta_crrection_path)<<endl;
  ...
  fPIDResponse->SetCustomTPCpidResponseOADBFile("/lustre/nyx/alice/users/mciupek/TPCSpline/SplineCreationFramework/TPCSplineFramework_SkimmedData/Splines/LHC18r/pileupcorrected/TPCPIDResponseOADB_2020_12_14_18r_pass3_It6.root");
  fPIDResponse->SetCustomTPCetaMaps("/lustre/nyx/alice/users/mciupek/TPCSpline/SplineCreationFramework/TPCSplineFramework_SkimmedData/Splines/LHC18r/pileupcorrected/TPCetaMaps_2020_12_14_18r_pass3_It6.root");
...
void cacheCleanV0(Int_t entries=-1, Int_t firstEntry=0, Int_t chunkSize=100000){
  ...
  treeV0->SetAlias("isMinBias","triggerMask&(3145763)");
...
void cacheEventFlat(){
  ...
  timer.Start();
  treeEvent->SetAlias("isMinBias","triggerMask&(3145763)");
...
void cacheCleanTrack(){
  ...
  tree->SetAlias("isMinBias","triggerMask&(3145763)");
  ...
  AliTreePlayer::MakeCacheTree(tree,cacheVariables.Data(),"CleanTrack.root","CleanTrackFlat","");

...
//--------------------------------------------------
Int_t checkShapeEta2(TString path = "/hera/alice/maschmid/train/V011.pPb/2015-11-17_1243.23219/mergedPeriods/pPb/5.023ATeV/LHC13c.pass2", Double_t multiplicityStepSize = 500/*-1 for all multiplicities*/,
...
//     binWidthsPt[i] = (binsPt[i + 1] - binsPt[i]) / 2.;
  ...
  //ATTENTION Overwritten later on 
  ...
  //Set Pt Bins on Bins of hPIDdata
  binsPt = hPIDdata->GetAxis(momentumAxis)->GetXbins()->GetArray();
  nPtBins = hPIDdata->GetAxis(momentumAxis)->GetNbins();

...
#ifndef ALITPCCALIBRESIDUALPID2_H
#define ALITPCCALIBRESIDUALPID2_H
...
class AliTPCcalibResidualPID2 : public AliAnalysisTaskSE {
 public:
  ...
  AliTPCcalibResidualPID2();
  AliTPCcalibResidualPID2(const char *name);
  virtual ~AliTPCcalibResidualPID2();
  ...
  static void CreatePlotWithOwnParameters(THnSparseF * histPidQA, const Bool_t useV0s, const Char_t * type, const Char_t * system, const Double_t* parameters, AliTPCcalibResidualPID2::FitType fitType, Float_t from = 0.9, Float_t to = 10e4);
  ...
  static TF1* SetUpFitFunction(const Double_t * initialParameters, AliTPCcalibResidualPID2::FitType fitType, Float_t from, Float_t to, Bool_t isPPb, Bool_t isMC, Double_t* parametersBBForward);
  ...
  AliTPCcalibResidualPID2(const AliTPCcalibResidualPID2&); // not implemented
  AliTPCcalibResidualPID2& operator=(const AliTPCcalibResidualPID2&); // not implemented
  
  ClassDef(AliTPCcalibResidualPID2, 6); 
};
